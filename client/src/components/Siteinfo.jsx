    ...
    <div className="p-6 mx-auto bg-white shadow-lg space-y-4 mt-4 border-2 border-purple-500 rounded-xl">
      ...
      <div className="flex items-center gap-2">
        ...
        {editField === "siteName" ? (
          ...
          <>
            <span className="flex-1">{siteInfo?.siteName || "N/A"}</span>
            <button
              className="bg-blue-500 text-white px-3 py-1 rounded"
              onClick={() => setEditField("siteName")}
            >
      ...
      <div className="flex items-center gap-2">
        ...
        {editField === "address" ? (
          ...
          <>
            <span className="flex-1">{siteInfo?.address || "N/A"}</span>
            <button
              className="bg-blue-500 text-white px-3 py-1 rounded"
              onClick={() => setEditField("address")}
            >
      ...
      <div className="flex items-center gap-2">
        ...
        {editField === "mobile" ? (
          ...
          <>
            <span className="flex-1">{siteInfo?.mobile || "N/A"}</span>
            <button
              className="bg-blue-500 text-white px-3 py-1 rounded"
              onClick={() => setEditField("mobile")}
            >
      ...
      <div className="flex items-center gap-2">
        ...
        {editField === "siteVideoUrl" ? (
          ...
          <>
            <span className="flex-1">{siteInfo?.siteVideoUrl || "N/A"}</span>
            <button
              className="bg-blue-500 text-white px-3 py-1 rounded"
              onClick={() => setEditField("siteVideoUrl")}
            >
        ...
        {editField === "siteDescriptionTitel" ? (
          ...
          <>
            <span className="flex-1">
              {siteInfo?.siteDescriptionTitel || "N/A"}
            </span>
            <button
              className="bg-blue-500 text-white px-3 py-1 rounded"
              onClick={() => setEditField("siteDescriptionTitel")}
      ...
      <div className="flex items-center gap-2">
        ...
        {editField === "siteDescription" ? (
          ...
          <>
            <span className="flex-1">{siteInfo?.siteDescription || "N/A"}</span>
            <button
              className="bg-blue-500 text-white px-3 py-1 rounded"
              onClick={() => setEditField("siteDescription")}
            >
